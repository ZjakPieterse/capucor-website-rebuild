        ...
        <div className="mt-12 grid sm:grid-cols-2 gap-6">
          {OUTCOMES.map((item, i) => (
            <ScrollReveal key={item.title} delay={i * 0.08}>
              <div className="flex gap-5 rounded-xl border border-border bg-card p-6 h-full transition-all duration-[250ms] hover:-translate-y-1 hover:shadow-lg hover:border-primary/20">
